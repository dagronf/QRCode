...
final class BugFixTests: XCTestCase {
	...
	func testExternalOptimizationIssue() throws {
		...
		let ud = QRCode.Document(utf8String: unoptim, generator: QRCodeGenerator_External())
		let od = QRCode.Document(utf8String: optim, generator: QRCodeGenerator_External())
