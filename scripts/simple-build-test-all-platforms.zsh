...
env DEVELOPER_DIR="/Applications/Xcode.app" xcrun swift build --target QRCodeDetector --arch arm64
env DEVELOPER_DIR="/Applications/Xcode.app" xcrun swift build --target QRCode --arch x86_64
env DEVELOPER_DIR="/Applications/Xcode.app" xcrun swift build --target QRCodeDetector --arch x86_64
...
env DEVELOPER_DIR="/Applications/Xcode.app" xcrun xcodebuild -IDEClonedSourcePackagesDirPathOverride="$PWD/sanitybuild/.dependencies" -derivedDataPath "$PWD/sanitybuild/.derivedData" build -scheme QRCodeDetector -destination "generic/platform=ios"
